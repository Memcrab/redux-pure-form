...
var _reduxPureFormMin = __webpack_require__(67);
...
var Example = function (_Component) {
  ...
  _createClass(Example, [{
    key: 'handle',
    value: function handle(e, formName) {
      var _props$fieldAttrs$onC;

      this.props.fieldAttrs.onChange((_props$fieldAttrs$onC = {}, _defineProperty(_props$fieldAttrs$onC, e.target.name, e.target.value), _defineProperty(_props$fieldAttrs$onC, formName + '.surnameduplicate', {
    ...
    key: 'setDefaults',
    value: function setDefaults(formName) {
      this.props.fieldAttrs.onChange(_defineProperty({}, formName, { name: 'superman' }));
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { type: 'button', onClick: function onClick() {
                return _this2.setDefaults('user');
              } },
            'set default values'
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', _extends({
            ...
            onChange: function onChange(e) {
              return _this2.handle(e, 'profile');
            }
          })),
          _react2.default.createElement('input', _extends({
            type: 'text',
          ...
          _react2.default.createElement(
            'select',
            _extends({ value: this.props.profile.gender, name: 'profile.gender' }, this.props.fieldAttrs),
            _react2.default.createElement(
              'option',
              { value: '1' },
              'male'
          ...
          _react2.default.createElement(
            'button',
            { type: 'button', onClick: function onClick() {
                return _this2.setDefaults('profile');
              } },
            'set default values'
          )
        ),
...
var user = (0, _reduxPureFormMin.createFormReducer)('user');

function ReducerWithNesting() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments[1];

  switch (action.type) {
    default:
      return (0, _reduxPureFormMin.formReducer)('profile')(state, action);
  }
}

/* eslint-disable no-underscore-dangle */
var store = (0, _redux.createStore)((0, _redux.combineReducers)({ user: user, ReducerWithNesting: ReducerWithNesting }), {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13), __webpack_require__(39)(module)))
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(16),B=__webpack_require__(2),C=__webpack_require__(0),ba=__webpack_require__(17),da=__webpack_require__(18),ea=__webpack_require__(19),fa=__webpack_require__(20),ia=__webpack_require__(21),D=__webpack_require__(4);
...
!function (e, r) {
  if (true) module.exports = r();else if ("function" == typeof define && define.amd) define([], r);else {
  ...
  return function (e) {
    ...
    }Object.defineProperty(r, "__esModule", { value: !0 }), r.createFormReducer = r.formReducer = r.mergeActionsToProps = r.formActions = r.formActionTypes = void 0;var u = t(1),
        c = o(u),
        a = t(2),
        i = o(a),
        f = t(3),
        l = n(f),
        s = t(4);r.formActionTypes = c, r.formActions = i, r.mergeActionsToProps = l.default, r.formReducer = s.formReducer, r.createFormReducer = s.createFormReducer;
  }, function (e, r) {
    "use strict";
    Object.defineProperty(r, "__esModule", { value: !0 });r.FIELD_ON_CHANGE = "FIELD_ON_CHANGE";
  }, function (e, r, t) {
    "use strict";
    function n(e, r, t) {
      ...
      if (e.type === i) {
        if (e.name.endsWith("[]")) return e.value;switch (!0) {case "true" === e.value:
            return e.checked;case "1" === e.value:
            return e.checked ? 1 : 0;default:
            return e.checked ? e.value : null;}
      }if (e.type === f) {
        var r = Array.prototype.reduce.call(e.options, function (e, r) {
          return r.selected ? e.concat(r.value) : e;
        }, []);return r;
      }return e.value;
    }function u(e) {
      ...
      var t = {};switch (!0) {case !("object" != typeof e || !e.type || !e.target):
          t = u(e);break;case !("string" != typeof e || void 0 === r):
          t = n({}, e, r);break;case !("object" != typeof e || void 0 !== r):
          t = e;break;default:
          console.warn("WARNING, not handled event in onChange");}return { type: a.FIELD_ON_CHANGE, payload: t };
    }Object.defineProperty(r, "__esModule", { value: !0 }), r.onChange = c;var a = t(1),
        i = "checkbox",
        f = "select-multiple";
  }, function (e, r) {
    "use strict";
    function t(e, r, t) {
      ...
      var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : c;return r.reduce(function (r, n) {
        return u({}, r, t({}, n, e[a[n]]));
      }, {});
    }function o(e, r, t) {
      return Object.assign({}, t, e, r, { fieldAttrs: n(r) });
      ...
      for (var r = 1; arguments.length > r; r++) {
        ...
        c = ["onChange"],
        a = { onChange: "onChange" };r.default = o;
  }, function (e, r, t) {
    "use strict";
    function n(e, r, t) {
      return r in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e;
    }function o(e) {
      return null !== e && "object" == typeof e && void 0 !== e.value ? "function" == typeof e.parser ? e.parser(e.value) : e.value : e;
    }function u(e, r, t, n) {
      var u = s(t, r) || [],
          c = o(n.payload[e]),
          a = u.indexOf(c),
          i = a > -1 ? u.slice(0, a).concat(u.slice(a + 1)) : u.concat(c);return i;
    }function c(e) {
      var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};return function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r,
            n = arguments[1];switch (n.type) {case f.FIELD_ON_CHANGE:
            var c = t,
                a = Object.keys(n.payload);return a.forEach(function (r) {
              if (r.startsWith(e + ".") || r === e) if (r.endsWith("[]")) {
                var t = r.slice(0, -2),
                    a = u(r, t, c, n);c = d(c, t, a);
              } else c = d(c, r, o(n.payload[r]));
            }), c;default:
            return t;}
      };
    }function a(e) {
      var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};return function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r,
            n = arguments[1];switch (n.type) {case f.FIELD_ON_CHANGE:
            var c = t,
                a = Object.keys(n.payload);return a[0] === e ? i({}, n.payload[e]) : (a.forEach(function (r) {
              if (r.startsWith(e + ".") || r === e) {
                var t = r.slice(e.length + 1);if (r.endsWith("[]")) {
                  t = t.slice(0, -2);var a = u(r, t, c, n);c = d(c, t, a);
                } else c = d(c, t, o(n.payload[r]));
              }
            }), c);default:
            return t;}
      };
    ...
    };r.formReducer = c, r.createFormReducer = a;var f = t(1),
        l = function l(e) {
      return Array.isArray(e) ? e : e.split(".");
    },
        s = function s(e, r, t) {
      return l(r).reduce(function (e, r) {
        return e && e[r] || t;
      }, e);
    },
        d = function d(e, r, t) {
      return l(r).reduceRight(function (r, t, o, u) {
        return Object.assign({}, s(e, u.slice(0, o)), n({}, t, r));
      }, t);
    };
  }]);
});
