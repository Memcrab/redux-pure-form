...
/***/ function(module, exports, __webpack_require__) {
	...
	function getInputValue(target) {
	  ...
	  if (target.type === INPUT_SELECT_MULTIPLE) {
	    ...
	    var values = Array.prototype.reduce.call(options, function (acc, option) {
	      if (option.selected) {
	  ...
	  var _ret = function () {
	    switch (action.type) {
	      case _actionTypes.FIELD_ON_CHANGE:
	        var newState = state;
	        action.payload.forEach(function (field) {
	          newState = (0, _set2.default)(field.name, field.value, newState);
	        });
	        return {
	          v: newState
	        };
